...
import {
  MusicTrack,
  MusicKeys as AvailableKeys,
} from '../../models/MusicTrack';
...
export class SetPage {
  ...
  constructor() {
    ...
    this.activeRoute.params.subscribe((params) => {
      ...
      this.currentTrackSet.set(
        this.localStorageService.getSet(this.currentTrackSetId()) ??
  ...
  onBlur(): void {
    ...
    this.localStorageService
      ...
      .then(() => this.currentStatus.set(SaveStatus.clean));
  }
